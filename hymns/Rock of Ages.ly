...
{
  \partial 2
  f'4. g'8 f'2 d'2 bf'4. g'8 f'1
  bf'4. c''8 d''2. c''4 bf' a' bf'1
  a'4. bf'8 c''2. c''4 a' f' bf'1
  a'4. bf'8 c''2. c''4 a' f' bf'1
  f'4. g'8 f'2 d'2 bf'4. g'8 f'1
  bf'4. c''8 d''2. c''4 bf' a' bf'1
}
altoNotes =
{
  d'4. ef'8 d'2 bf d'4. ef'8 d'1
  f'4. g'8 f'2. ef'4 d' c' d'1
  c'4. d'8 ef'2. ef'4 ef' ef' d'1
  c'4. d'8 ef'2. ef'4 ef' ef' d'1
  d'4. ef'8 d'2 bf d'4. ef'8 d'1
  f'4. g'8 f'2. ef'4 d' c' d'1
}
...
bassNotes =
{
  bf,4. bf,8 bf,2 bf, bf,4. bf,8 bf,1
  d4. ef8 f2. f4 f f bf,1
  f4. f8 f2. f4 f f bf,1
  f4. f8 f2. f4 f f bf,1
  bf,4. bf,8 bf,2 bf, bf,4. bf,8 bf,1
  d4. ef8 f2. f4 f f bf,1
}
